...
export default function Manaslu() {
  const mountain = mountainData.manaslu;
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-md p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-indigo-50 p-4 rounded-md">
            <h3 className="text-lg font-semibold text-indigo-800">Price</h3>
            <p className="text-3xl font-bold text-indigo-600">${mountain.price.toLocaleString()}</p>
            <p className="text-sm text-gray-600 mt-2">Per Person</p>
            <button className="mt-4 bg-indigo-600 text-white px-6 py-2 rounded-md hover:bg-indigo-700 transition-colors w-full">Book Now</button>
          </div>
        </div>
      </div>
      ...
      {/* Unique Feature: Helicopter Return */}
      <div className="container mx-auto px-4 py-8">
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-md">
          <h3 className="text-xl font-bold text-yellow-800 mb-2">Special Feature: Helicopter Return</h3>
          <p className="text-gray-700">
            This expedition includes a thrilling helicopter return flight from Samagaon to Kathmandu, 
            saving you days of trekking and adding an unforgettable experience to your adventure!
          </p>
        </div>
      </div>
      ...
      <div className="bg-indigo-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Challenge the 8th Highest Peak in the World</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">Join our expedition to Mount Manaslu and test your limits on this magnificent 8,000m peak.</p>
          <div className="flex justify-center space-x-4">
            <button className="bg-white text-indigo-900 px-8 py-3 rounded-md font-semibold hover:bg-gray-100 transition-colors">Book Now</button>
            <button className="border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-indigo-800 transition-colors">Contact Us</button>
          </div>
        </div>
      </div>
    </div>
